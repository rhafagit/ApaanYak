...
$detail_order = mysqli_query($kon, "SELECT * FROM tb_pesanan WHERE id_order  = '$id'");
$q_hartot = mysqli_query($kon, "SELECT sum(hartot_dorder) as hartot FROM tb_pesanan WHERE id_order = '$id'");
        ...
        <div class="col-md-6 mx-auto" style="border: 1px solid #000;">
          ...
          <div class="row">
            <?php foreach ($detail_order as $do) :
              $q_masakan = mysqli_query($kon, "SELECT * FROM tb_menu WHERE id_masakan = '$do[id_masakan]'");
