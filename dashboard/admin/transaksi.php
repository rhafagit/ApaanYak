...
if (isset($_GET['meja'])) {
    $query_order = mysqli_query($kon, "SELECT * FROM tb_pelanggan WHERE meja_order = '$_GET[meja]' ORDER BY id_order DESC");
    $order = mysqli_fetch_assoc($query_order);
    $detail_order = mysqli_query($kon, "SELECT * FROM tb_pesanan WHERE id_order = '$order[id_order]'");
}
                    ...
                    <table class="table table-bordered table-hover table-striped" id="tabel">
                        ...
                        <?php if (isset($_GET['meja'])): ?>
                            ...
                            <?php $i = 1;
                                ...
                                $query_mas = mysqli_query($kon, "SELECT * FROM tb_menu WHERE id_masakan = '$row[id_masakan]'");
                ...
                <div class="col-md-4">
                    <form action="fungsi/prosesTransaksi.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if (isset($_GET['meja'])) {
                                $q_hartot = mysqli_query($kon, "SELECT sum(hartot_dorder) as hartot FROM tb_pesanan WHERE id_order = '$order[id_order]'");
