    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: <?= $color ?>;">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="assets/image/logo_resto.png" alt="" width="60" height="60" class="mb-1">
          Komeng House
        </a>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <?php
        ...
        $list_pesanan = mysqli_query($kon, "SELECT * FROM tb_pesanan WHERE id_order = 'ORD000$no_order' AND id_user = '$_SESSION[id_user]'");
        $nono = 'ORD000' . $no_order;
        $query_hartot = mysqli_query($kon, "SELECT sum(hartot_dorder) as hartot FROM tb_pesanan WHERE id_order = '$nono'");
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <?php $i = 1;
                    ...
                    $masakan = mysqli_query($kon, "SELECT * FROM tb_menu WHERE id_masakan = '$pesanan[id_masakan]' ");
