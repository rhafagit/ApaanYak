...
if (isset($_POST['ubah_foto'])) {
	...
	if (move_uploaded_file($tmp, $path)) {
		$query = "SELECT FROM tb_menu WHERE id_masakan='$id'";
		...
		$query = "UPDATE tb_menu SET kategori_masakan='$kategori', nama_masakan='$nama', harga_masakan='$harga', foto='$fotobaru', status_masakan='$status' WHERE id_masakan='$id'";
		$sql = mysqli_query($kon, $query);
	...
	$query = "UPDATE tb_menu SET kategori_masakan='$kategori', nama_masakan='$nama', harga_masakan='$harga', status_masakan='$status' WHERE id_masakan='$id'";
	$sql = mysqli_query($kon, $query);		
