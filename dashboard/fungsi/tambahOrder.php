...
$tanggal = time(); // Timestamp
$tanggal2 = date('d-m-Y'); // Format tanggal
...
// Ganti dengan nama kolom yang benar!
...
// Tambah ke tb_pelanggan
$queryTambah = "INSERT INTO tb_pelanggan VALUES('$id_order', '$meja', '$tanggal', '$tanggal2', '$user_id', '$keterangan', 0)";
