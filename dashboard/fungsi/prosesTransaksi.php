...
$q_detailOrder = mysqli_query($kon, "SELECT * FROM tb_pesanan WHERE id_order = '$id_order'");
...
if ($uang < $total_bayar) {
    ...
    mysqli_query($kon, "UPDATE tb_pelanggan set status_order = 1 WHERE id_order = '$id_order'");
