...
$id  = $_GET['id'];
$query_order = mysqli_query($kon, "SELECT * FROM tb_pelanggan WHERE id_order = '$id'");
$order = mysqli_fetch_assoc($query_order);
$hapus_order = "DELETE FROM tb_pelanggan WHERE id_order = '$id'";
mysqli_query($kon, "DELETE FROM tb_pesanan WHERE id_order = '$id'");
